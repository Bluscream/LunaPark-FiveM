...
namespace LunaPark
{
	internal class RollerCoasterCamCinematica
	{
		...
		public Vector3 Value2 = new Vector3(0f);
		...
		public float Value16 = 0f;

		public float Value17 = 0f;

		public float Value18 = 0f;
		...
		public float Value26 = 0f;

		public float Value27 = 0f;

		public float Value28 = 0f;

		public float Value29 = 0f;

		public float Value30 = 0f;
	}
}
